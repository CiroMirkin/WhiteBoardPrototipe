...
export const ContextMenu = ({ x, y, onDelete, onResize, onDownload, onCrop, isImage, onClose, showResize = true }: ContextMenuProps) => {
  const handleDelete = () => {
  ...
  return (
    ...
    >
      ...
      {isImage && onCrop && (
        <button className="context-menu__button" onClick={onCrop}>
          Recortar
        </button>
      )}
      {isImage && onDownload && (
